...
INSERT INTO `stms_admin` (`seq_id`, `username`, `realname`, `password`, `salt`, `address`, `mobile_phone`, `contact_number`, `email`, `descr`, `status`, `portal_key`, `property_id`, `sex`, `user_type`, `photo_url`, `create_time`, `update_time`, `dversion`, `is_del`, `data_order`) VALUES
	(100001, 'admin', 'admin', '41f15d993cb4742604ef89b27dfd76109996b673818167326d6d476ca3333e84', 'eEvsFy1J7ux+cg4iehJLry9mgq6/jfQ6bKwPLj8tGy0=', NULL, '1', NULL, '2', NULL, 0, 'stadmin', NULL, 0, 1, NULL, '2018-05-14 16:34:29', '2018-09-11 09:47:37', 0, 0, 100);
...
CREATE TABLE IF NOT EXISTS `stms_autho` (
  ...
  `data_order` int(11) DEFAULT '100' COMMENT '排序',
  PRIMARY KEY (`seq_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10012 DEFAULT CHARSET=utf8 COMMENT='权限';
...
CREATE TABLE IF NOT EXISTS `stms_role` (
  ...
  `data_order` int(11) DEFAULT '100' COMMENT '排序',
  PRIMARY KEY (`seq_id`)
) ENGINE=InnoDB AUTO_INCREMENT=100002 DEFAULT CHARSET=utf8 COMMENT='系统角色';
...
CREATE TABLE IF NOT EXISTS `stms_role_has_autho` (
  ...
  `data_order` int(11) DEFAULT '100',
  PRIMARY KEY (`seq_id`)
) ENGINE=InnoDB AUTO_INCREMENT=10012 DEFAULT CHARSET=utf8 COMMENT='角色拥有权限';
...
-- 正在导出表  stadmin.stms_token 的数据：~7 rows (大约)
...
INSERT INTO `stms_token` (`seq_id`, `user_id`, `expire_time`, `create_time`, `update_time`, `dversion`, `is_del`) VALUES
	('2cb0f870e416f5b6420772128fb1602a', 100001, '2018-09-10 16:49:28', '2018-09-09 16:49:28', NULL, 0, 0),
	('509ee33ed28f5a91aa097017f04f9991', 100001, '2018-09-10 16:54:14', '2018-09-09 16:54:13', NULL, 0, 0),
	('5e147e1af1a4c06f8b56f3d2c2071952', 100001, '2018-09-10 16:45:13', '2018-09-09 16:45:12', '2018-09-09 16:45:22', 0, 1),
	('79ade05862c09b0120eea9a66aa92094', 100001, '2018-09-09 23:21:05', '2018-09-08 23:21:03', '2018-09-09 16:36:28', 0, 1),
	('8bcfbed1a33130a4fd18e8fcf8cf2a0d', 100001, '2018-09-10 16:45:29', '2018-09-09 16:45:29', '2018-09-09 16:47:05', 0, 1),
	('c550bd444533b6b8710f71a3a4e5dc76', 100001, '2018-09-10 17:07:18', '2018-09-09 17:07:18', '2018-09-09 17:11:49', 0, 1),
	('f7a03690bc136557add1db23c4cbf19c', 100001, '2018-09-10 17:11:56', '2018-09-09 17:11:56', NULL, 0, 0);
...
CREATE TABLE IF NOT EXISTS `stms_user_has_role` (
  ...
  `data_order` int(11) DEFAULT '100',
  PRIMARY KEY (`seq_id`)
) ENGINE=InnoDB AUTO_INCREMENT=100002 DEFAULT CHARSET=utf8 COMMENT='用户角色';
...
) ENGINE=InnoDB AUTO_INCREMENT=374 DEFAULT CHARSET=utf8mb4 COMMENT='配置';
...
INSERT INTO `stm_gconfig` (`seq_id`, `update_time`, `create_time`, `is_del`, `group_name`, `config_name`, `config_val`, `config_memo`, `portal_key`) VALUES
	...
	(373, '2018-09-09 21:11:00', '2018-08-02 14:34:27', 1, 'test1', 'test', 'tes2', '测试', '');
...
) ENGINE=InnoDB AUTO_INCREMENT=2033 DEFAULT CHARSET=utf8mb4 COMMENT='商品';

-- 正在导出表  stadmin.stm_goods 的数据：~75 rows (大约)
