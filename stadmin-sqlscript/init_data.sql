...
DROP TABLE IF EXISTS `stms_admin`;
...
-- 正在导出表  stadmin.stms_admin 的数据：~2 rows (大约)
...
INSERT INTO `stms_admin` (`seq_id`, `username`, `realname`, `password`, `salt`, `address`, `mobile_phone`, `contact_number`, `email`, `descr`, `status`, `portal_key`, `property_id`, `sex`, `user_type`, `photo_url`, `create_time`, `update_time`, `dversion`, `is_del`, `data_order`) VALUES
	(100001, 'admin', 'admin1', '7c4a8d09ca3762af61e59520943dc26494f8941b', '', NULL, '1', NULL, '2', NULL, 0, 'stadmin', NULL, 0, 1, NULL, '2018-05-14 16:34:29', '2018-05-25 15:38:46', 0, 0, 100);
/*!40000 ALTER TABLE `stms_admin` ENABLE KEYS */;

-- 导出  表 stadmin.stms_autho 结构
DROP TABLE IF EXISTS `stms_autho`;
...
-- 正在导出表  stadmin.stms_autho 的数据：~47 rows (大约)
...
DROP TABLE IF EXISTS `stms_dict_data`;
...
DROP TABLE IF EXISTS `stms_login_log`;
...
-- 正在导出表  stadmin.stms_org 的数据：~0 rows (大约)
...
DROP TABLE IF EXISTS `stms_org_has_user`;
...
-- 正在导出表  stadmin.stms_org_has_user 的数据：~0 rows (大约)
...
DROP TABLE IF EXISTS `stms_portal`;
...
-- 正在导出表  stadmin.stms_portal 的数据：~0 rows (大约)
...
DROP TABLE IF EXISTS `stms_role`;
...
-- 正在导出表  stadmin.stms_role 的数据：~2 rows (大约)
...
DROP TABLE IF EXISTS `stms_role_has_autho`;
...
-- 正在导出表  stadmin.stms_role_has_autho 的数据：~101 rows (大约)
...
INSERT INTO `stms_role_has_autho` (`seq_id`, `role_id`, `autho_id`, `create_time`, `update_time`, `dversion`, `is_del`, `data_order`) VALUES
	(1135, 100001, 1124, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1136, 100001, 1125, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1137, 100001, 1126, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1138, 100001, 1127, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1139, 100001, 1128, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1140, 100001, 1129, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1141, 100001, 1130, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1142, 100001, 1171, '2018-05-14 16:34:29', '2018-09-09 12:18:46', 0, 0, 100),
	(1143, 100001, 1172, '2018-05-14 16:34:29', '2018-09-09 12:18:48', 0, 0, 100),
	(1144, 100001, 1173, '2018-05-14 16:34:29', '2018-09-09 12:18:51', 0, 0, 100),
	(1145, 100001, 1174, '2018-05-14 16:34:29', '2018-09-09 12:18:53', 0, 0, 100),
	(1146, 100001, 1175, '2018-05-14 16:34:29', '2018-09-09 12:18:55', 0, 0, 100),
	(1147, 100001, 1136, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1148, 100001, 1137, '2018-05-14 16:34:29', '2018-07-09 16:35:02', 0, 0, 100),
	(1172, 100001, 1161, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1173, 100001, 1162, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1174, 100001, 1163, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1175, 100001, 1164, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1176, 100001, 1165, '2018-05-14 16:34:29', '2018-05-14 16:34:29', 0, 0, 100),
	(1200, 100001, 10000, '2018-05-17 10:31:47', NULL, 0, 0, 100),
	(1201, 100001, 10001, '2018-05-17 10:32:33', NULL, 0, 0, 100),
	(1202, 100001, 10002, '2018-05-17 10:32:35', NULL, 0, 0, 100),
	(1203, 100001, 10003, '2018-05-17 10:32:35', NULL, 0, 0, 100),
	(1204, 100001, 10004, '2018-05-17 10:32:35', NULL, 0, 0, 100),
	(1205, 100001, 10005, '2018-05-17 10:32:36', NULL, 0, 0, 100),
	(1212, 100001, 10007, '2018-08-01 14:50:20', NULL, 0, 0, 100),
	(1213, 100001, 10008, '2018-08-01 15:33:00', '2018-08-01 15:42:33', 0, 0, 100),
	(1214, 100001, 10009, '2018-08-01 15:53:44', NULL, 0, 0, 100),
	(1215, 100001, 10010, '2018-08-01 15:54:07', NULL, 0, 0, 100),
	(1216, 100001, 10011, '2018-08-01 15:54:20', NULL, 0, 0, 100);
/*!40000 ALTER TABLE `stms_role_has_autho` ENABLE KEYS */;

-- 导出  表 stadmin.stms_token 结构
DROP TABLE IF EXISTS `stms_token`;
...
-- 正在导出表  stadmin.stms_token 的数据：~64 rows (大约)
...
DROP TABLE IF EXISTS `stms_user_has_role`;
...
-- 正在导出表  stadmin.stms_user_has_role 的数据：~3 rows (大约)
...
DROP TABLE IF EXISTS `stm_gconfig`;
...
-- 正在导出表  stadmin.stm_gconfig 的数据：~162 rows (大约)
...
DROP TABLE IF EXISTS `stm_goods`;
...
-- 正在导出表  stadmin.stm_goods 的数据：~84 rows (大约)
...
DROP TABLE IF EXISTS `stm_goods_classify`;
