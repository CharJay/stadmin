...
layui.define(['laytpl', 'layer', 'util','jquery'], function(exports){
  exports('setter', {
    ...
    ,urls :{
        ...
        deleteById :    '/crud/${0}/deleteById',
        updateById :    '/crud/${0}/updateById',
        ...
        updateGoodsStatusById: '/crud/stmGoods/updateStatusById',
        getGoodsContentById: '/crud/stmGoods/getGoodsContentById',
        getClassify: '/crud/stmGoods/getClassify',
        uploadEditorImgUrl: '/uploadEditorImg',
        //giftcard
        cardCreate: '/giftcard/cardCreate',
        cardExport: '/giftcard/cardExport',
        //News
        createContent:'/crud/stmNews/createContent',
        getContent:'/crud/stmNews/getContent',
    }
